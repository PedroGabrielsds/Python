...
sexo = str(input(f"Informe o seu sexo: [M/F] ")).upper().strip()

while((sexo != 'M') and (sexo != 'F')):
    sexo = str(input(f"\033[1;31;40mDado inválido\033[m, por favor informe seu sexo novamente: [M/F] ")).upper().strip()
