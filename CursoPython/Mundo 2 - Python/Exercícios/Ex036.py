...
if(valor_parcela > porcentagem_salario):
    print(f"\033[1;31;40mPara pagar uma casa de R${valor_casa} em {anos} anos a prestação será de R${valor_parcela:.2f}\033[m")
    ...
    print(f"Sua parcela ficou no valor de \033[1;32;40mR${valor_parcela:.2f}\033[m por mês durante \033[1;33;40m{anos}\033[m anos!")